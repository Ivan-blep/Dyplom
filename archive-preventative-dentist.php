    ...
    <section class="services-archive-hero">
        <div class="grid-container">
            <div class="services-archive-hero__content-container">
                <div class="services-archive-hero__title animated-element slide-left preventative-title">
                    <?php echo get_field('preventative_dentistry_title', 'options') ?? '' ?>
                </div>
                <div class="services-archive-hero__content animated-element slide-right preventative-content">
                    <?php echo get_field('preventative_dentistry_content', 'options') ?? '' ?>
                </div>
            </div>
